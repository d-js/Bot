...
async function main() {
  ...
  if (platform === 'win32') {
    try {
      ...
      external_fs_default.a.writeFileSync(gitBashFile, modifyGitBashFile());
...
module.exports = {"name":"now","version":"15.2.0","preferGlobal":true,"license":"Apache-2.0","description":"The command-line interface for Now","repository":"zeit/now-cli","scripts":{"test":"yarn test-lint","test-unit":"nyc ava test/*unit.js --fail-fast","test-integration":"ava test/integration.js --serial --fail-fast","test-lint":"eslint . --ext .js,.ts","prepublishOnly":"yarn build-download && cp download/default.js download/dist/now","coverage":"nyc report --reporter=text-lcov > coverage.lcov && codecov","postinstall":"node download/install.js","gzip":"ls packed/now* | xargs gzip","bundle":"pkg bin/now.js -c package.json -o packed/now --options no-warnings","pack":"rm -rf packed && yarn build && yarn bundle","build-download":"ncc build ./download/src --out ./download/dist","link":"yarn run build-dev && cd link && npm link","build":"node build.js","build-dev":"node build.js --dev","format-modified":"prettier --parser typescript --write --single-quote `git diff --name-only | grep -e \".*\\.ts$\" -e \".*\\.js$\" | xargs echo`"},"nyc":{"include":["src/**"],"extension":[".js",".ts"],"require":["ts-node/register"],"reporter":["text","html"],"sourceMap":true,"instrument":true,"all":true},"git":{"pre-commit":["test-lint","format-modified"]},"bin":{"now":"download/dist/now"},"files":["download/dist","download/install.js"],"pkg":{"scripts":["dist/*.js"],"assets":["dist/runtimes"],"targets":["node10.4.1-alpine-x64","node10.4.1-linux-x64","node10.4.1-macos-x64","node10.4.1-win-x64"]},"ava":{"compileEnhancements":false,"extensions":["ts"],"require":["ts-node/register/transpile-only","esm"]},"devDependencies":{"@now/build-utils":"0.5.2-canary.0","@sentry/node":"4.5.3","@types/ansi-escapes":"3.0.0","@types/ansi-regex":"4.0.0","@types/async-retry":"1.2.1","@types/bytes":"3.0.0","@types/debug":"0.0.31","@types/dotenv":"6.1.1","@types/execa":"0.9.0","@types/fs-extra":"5.0.5","@types/glob":"7.1.1","@types/http-proxy":"1.16.2","@types/load-json-file":"2.0.7","@types/micro":"7.3.3","@types/mime-types":"2.1.0","@types/minimatch":"3.0.3","@types/mkdirp":"0.5.2","@types/mkdirp-promise":"5.0.0","@types/mri":"1.1.0","@types/ms":"0.7.30","@types/node":"11.11.0","@types/node-fetch":"2.1.4","@types/npm-package-arg":"6.1.0","@types/pluralize":"0.0.29","@types/psl":"1.1.0","@types/tar-fs":"1.16.1","@types/text-table":"0.2.0","@types/write-json-file":"2.2.1","@typescript-eslint/eslint-plugin":"1.6.0","@typescript-eslint/parser":"1.1.0","@zeit/dockerignore":"0.0.5","@zeit/fun":"0.8.0","@zeit/git-hooks":"0.1.4","@zeit/ncc":"0.18.1","@zeit/nsfw":"3.0.0","@zeit/source-map-support":"0.6.2","alpha-sort":"2.0.1","ansi-escapes":"3.0.0","ansi-regex":"3.0.0","arg":"2.0.0","async-listen":"1.2.0","async-retry":"1.1.3","async-sema":"2.1.4","ava":"1.4.1","bytes":"3.0.0","cache-or-tmp-directory":"1.0.0","chalk":"2.3.1","clipboardy":"1.1.4","codecov":"3.1.0","cpy":"7.2.0","credit-card":"3.0.1","date-fns":"1.29.0","death":"1.1.0","debug":"3.1.0","deployment-type":"1.0.1","docker-file-parser":"1.0.2","dotenv":"4.0.0","download":"6.2.5","email-prompt":"0.3.2","email-validator":"1.1.1","epipebomb":"1.0.0","eslint":"5.16.0","eslint-config-airbnb":"17.1.0","eslint-config-prettier":"4.1.0","eslint-import-resolver-typescript":"1.1.1","eslint-plugin-import":"2.16.0","eslint-plugin-jsx-a11y":"6.2.1","eslint-plugin-react":"7.12.4","esm":"3.0.84","execa":"1.0.0","fetch-h2":"2.0.3","fs-extra":"7.0.1","glob":"7.1.2","http-proxy":"1.17.0","ini":"1.3.4","inquirer":"3.3.0","is-url":"1.2.2","jaro-winkler":"0.2.8","jsonlines":"0.1.1","load-json-file":"3.0.0","micro":"9.1.2","mime-types":"2.1.18","minimatch":"3.0.4","mkdirp":"0.5.1","mkdirp-promise":"5.0.1","mri":"1.1.0","ms":"2.1.1","node-fetch":"1.7.3","npm-package-arg":"6.1.0","nyc":"13.2.0","ora":"3.4.0","pcre-to-regexp":"0.0.5","pkg":"4.3.8","pluralize":"7.0.0","pre-commit":"1.2.2","prettier":"1.16.2","printf":"0.2.5","progress":"2.0.3","promisepipe":"3.0.0","psl":"1.1.31","qr-image":"3.2.0","raw-body":"2.3.3","read-pkg":"2.0.0","rx-lite-aggregates":"4.0.8","semver":"5.5.0","serve-handler":"5.0.7","sinon":"4.4.2","strip-ansi":"5.2.0","stripe":"5.1.0","tar-fs":"1.16.3","test-listen":"1.1.0","text-table":"0.2.0","through2":"2.0.3","title":"3.4.1","tmp-promise":"1.0.3","ts-node":"7.0.1","typescript":"3.2.4","update-check":"1.5.3","utility-types":"2.1.0","which-promise":"1.0.0","write-json-file":"2.2.0","yarn":"1.13.0"}};
